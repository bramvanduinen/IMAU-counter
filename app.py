...
def reset_data():
    with app.app_context():
        ...
        update_entry = DeskUpdate(
            desks_with_monitor=data["desks_with_monitor"],
            desks_without_monitor=data["desks_without_monitor"],
        )
...
scheduler.add_job(
    func=reset_data, trigger="interval", days=1, start_date="2022-01-01 00:00:00"
)
scheduler.start()
